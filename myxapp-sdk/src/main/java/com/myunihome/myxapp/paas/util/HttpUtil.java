...
public class HttpUtil {
	 ...
	 */
	public static String doPost(String urlAddr, StringEntity param) {
		return doPost(urlAddr, param, null, MyXAppPaaSConstant.CHARSET_UTF8,
	...
	public static String doPost(String urlAddr, Map<String, String> param,
			int cnnTimeOut) {
		return doPost(urlAddr, param, MyXAppPaaSConstant.CHARSET_UTF8,
				MyXAppPaaSConstant.CHARSET_UTF8, MyXAppPaaSConstant.CHARSET_UTF8,
				MyXAppPaaSConstant.CHARSET_UTF8, cnnTimeOut);
	...
	public static String doPost(String urlAddr, Map<String, String> param) {
		...
		return doPost(urlAddr, param, MyXAppPaaSConstant.CHARSET_UTF8,
				MyXAppPaaSConstant.CHARSET_UTF8, MyXAppPaaSConstant.CHARSET_UTF8,
				MyXAppPaaSConstant.CHARSET_UTF8, _cnnTimeOut, _cnnRequestTimeOut,
				_socketTimeOut);
	}
	...
	public static String doGet(String urlAddr, Map<String, String> param,
			...
			int socketTimeOut) {
		return doGet(urlAddr, param, header, MyXAppPaaSConstant.CHARSET_UTF8,
				MyXAppPaaSConstant.CHARSET_UTF8, MyXAppPaaSConstant.CHARSET_UTF8,
	...
	public static String doGet(String urlAddr, Map<String, String> param) {
		return doGet(urlAddr, param, null, MyXAppPaaSConstant.CHARSET_UTF8,
				MyXAppPaaSConstant.CHARSET_UTF8, MyXAppPaaSConstant.CHARSET_UTF8,
				_cnnTimeOut, _cnnRequestTimeOut, _socketTimeOut);
	}
	...
	public static String doPostSSL(String urlAddr, Map<String, Object> param) {
		...
		try {
			...
			httpPost.setEntity(new UrlEncodedFormEntity(pairList,
					MyXAppPaaSConstant.CHARSET_UTF8));
			response = httpClient.execute(httpPost);
			if (HttpStatus.SC_OK == response.getStatusLine().getStatusCode()) {
				HttpEntity entity = response.getEntity();
				return EntityUtils.toString(entity, MyXAppPaaSConstant.CHARSET_UTF8);
			} else {
				throw new PaasRuntimeException(""
						+ response.getStatusLine().getStatusCode(), response
						.getStatusLine().toString());
