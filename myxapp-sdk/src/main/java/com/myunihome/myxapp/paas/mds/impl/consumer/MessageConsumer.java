package com.myunihome.myxapp.paas.mds.impl.consumer;
...
import com.myunihome.myxapp.paas.mds.IMessageConsumer;
import com.myunihome.myxapp.paas.mds.IMessageProcessor;
import com.myunihome.myxapp.paas.mds.IMsgProcessorHandler;
...
import com.myunihome.myxapp.paas.mds.impl.consumer.client.KafkaConsumer;
...
import com.myunihome.myxapp.paas.uniconfig.zookeeper.ConfigWatcher.Event.KeeperState;
import com.myunihome.myxapp.paas.uniconfig.zookeeper.ConfigWatcherEvent;
...
public class MessageConsumer implements IMessageConsumer {
	...
	private String id = UUIDUtil.genId32();
	...
	public MessageConsumer init() {
		...
		runningLockPath = (kafkaConfig._stateConf
				.get(Config.MDS_PARTITION_RUNNING_LOCK_PATH) + MyXAppPaaSConstant.UNIX_SEPERATOR);
		pauseLockPath = (kafkaConfig._stateConf
				.get(Config.MDS_PARTITION_PAUSE_LOCK_PATH) + MyXAppPaaSConstant.UNIX_SEPERATOR);
