...
public class CertUtil
{
  ...
  public static void main(String[] args) {
    ...
    String sign = sign(strSendData, "GBK", "/Volumes/HD/Downloads/weg_private_key.pfx", "aipay123456", "aipay654321");

    System.out.println(sign);
    boolean ret = verifySignatureWithCharset(sign, strSendData, "/Volumes/HD/Downloads/weg_public_key.cer", "GBK");
